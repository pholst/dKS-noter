...
I vores tilfælde gør vi dette vha. nogle gadgets. Den første af disse er en såkaldt ``choice gadget'', som illustreret herunder.
\begin{center}
...
\end{center}
Denne gadget skal så bruges som en delgraf forbundet til resten vha. de sorte knuder. Vores choice gadget vil så gøre, at vi kan tildele forskellige sandhedsværdier afhængig af hvilken kant Hamilton stien vælger ned igennem delgrafen og derved modellere en boolsk variabel. 
